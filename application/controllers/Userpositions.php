...
class Userpositions extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->mainModel = $this->userposition_m;
    }
    ...
    public function manage()
    {
        ...
        $this->data['title'] = '行政管理 ＞ 职位管理';
        $this->data["subscript"] = "settings/script";
        $this->data["subcss"] = "settings/css";
        $this->data['apiRoot'] = $apiRoot = 'userpositions/manage';
        $this->data['mainModel'] = 'tbl_user_position';
