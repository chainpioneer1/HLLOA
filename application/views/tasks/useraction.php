...
<div class="base-container">
    ...
    <div class="content-area">
        ...
        <div class="content-pagination" style="background-color: white;">
...
<div class="scripts">
    ...
    <script>
        ...
        $(function () {
            ...
            setTimeout(function () {
                window.showPage = function (perPage, totalPages, urlRoot) {
                    ...
                    $('.useraction-form').attr('action', baseURL + urlRoot + '/' + pageNum);
                    $('.useraction-form').submit();
                };
                $('.pagination a').off('click');
                $('.pagination a').on('click', function () {
                    var elem = $(this);
                    $('.useraction-form').attr('action', elem.attr('data-target'));
                    $('.useraction-form').submit();
                })
            }, 5);
        });
        ...
        var _titleStr = ['当前任务情况', '未接收', '进行中', '待验收', '完成任务列表'];
        var _editItemId = 0;
        var _rangeFrom = '<?= $range_from?>'.substr(0, 7);
        var _rangeTo = '<?= $range_to?>'.substr(0, 7);
