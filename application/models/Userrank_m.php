...
class Userrank_m extends MY_Model
{
    protected $_table_name = 'tbl_user_rank';
    protected $_primary_key = 'id';
    protected $_primary_filter = 'intval';
    protected $_order_by = "tbl_user_rank.title asc";
    ...
    public function getItemsByPage($arr = array(), $pageId, $cntPerPage, $queryStr = '')
    {
        ...
        if ($queryStr != '') {
            $this->db->where(
                ...
                . "or {$this->_table_name}.standard_factor like '%{$queryStr}%' "
                . "or {$this->_table_name}.rank_factor like '%{$queryStr}%' )"
            );
        }
