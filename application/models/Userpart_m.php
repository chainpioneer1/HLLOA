...
class Userpart_m extends MY_Model
{
    protected $_table_name = 'tbl_user_part';
    protected $_primary_key = 'id';
    protected $_primary_filter = 'intval';
    protected $_order_by = "tbl_user_part.title asc";
    ...
    public function getItemsByPage($arr = array(), $pageId, $cntPerPage, $queryStr = '')
    {
        ...
        $this->db->from($this->_table_name)
            ->join("tbl_user", "{$this->_table_name}.boss_id = tbl_user.id", "left")
