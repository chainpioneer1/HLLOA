...
!function (e) {
    ...
    Z.dateRangePickerLanguages = {
        ...
        function z(e, t) {
            ...
            m.find("." + t + " .month-name").html( n+ "年" + a), m.find("." + t + " tbody").html(function (e) {
                var t = [];
                e.setDate(1);
